...
Prefer the installed entry point once the package is installed:
    ...
    uv sync
    uv run mayo-baseline predict albi --bilirubin_umol_l 20 --albumin_g_l 40
...
behaviour it has is `mayo_baseline.cli`'s.
"""
...
from mayo_baseline.cli import main  # noqa: E402
